...
public class VaadinTemplate extends PolymerTemplate<VaadinTemplate.HelloWorldModel> {

  /** Template constructor. */
  public VaadinTemplate() {
  ...
  /**
   * A model interface that defined the data that is communicated between the server and the client.
   */
